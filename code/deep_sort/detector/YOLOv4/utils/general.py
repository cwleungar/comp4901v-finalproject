...
from detector.YOLOv4.utils import TryExcept, emojis
from detector.YOLOv4.utils.downloads import gsutil_getsize
from detector.YOLOv4.utils.metrics import box_iou, fitness
...
def check_amp(model):
    ...
    from detector.YOLOv4.models.common import AutoShape, DetectMultiBackend
...
def strip_optimizer(f='best.pt', s=''):  # from detector.YOLOv4.utils.general import *; strip_optimizer()
