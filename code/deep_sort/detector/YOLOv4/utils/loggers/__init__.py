...
from detector.YOLOv4.utils.general import LOGGER, colorstr, cv2
from detector.YOLOv4.utils.loggers.clearml.clearml_utils import ClearmlLogger
from detector.YOLOv4.utils.loggers.wandb.wandb_utils import WandbLogger
from detector.YOLOv4.utils.plots import plot_images, plot_labels, plot_results
from detector.YOLOv4.utils.torch_utils import de_parallel
...
try:
    if RANK not in [0, -1]:
        ...
        from detector.YOLOv4.utils.loggers.comet import CometLogger
...
class GenericLogger:
    ...
    Usage: from detector.YOLOv4.utils.loggers import GenericLogger; logger = GenericLogger(...)
    Arguments
        opt:             Run arguments
