...
from detector.YOLOv5.utils import TryExcept, emojis
from detector.YOLOv5.utils.downloads import curl_download, gsutil_getsize
...
def strip_optimizer(f='best.pt', s=''):  # from detector.YOLOv5.utils.general import *; strip_optimizer()
